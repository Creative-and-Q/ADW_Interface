...
export class CodeTestingAgent {
   ...
   */
  private async autoExtractAndWriteTests(response: string, workingDir: string): Promise<string[]> {
    const results: string[] = [];
...
5. When all tests pass, say: "TESTING COMPLETE"
   ...
   */
  private truncateMessages(messages: AIMessage[], maxMessages: number = 6): AIMessage[] {
