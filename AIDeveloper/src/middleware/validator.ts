 ...
 */
export function validateGitHubPayload(req: Request, res: Response, next: NextFunction): void {
  try {
 ...
 */
export function validateGitLabPayload(req: Request, res: Response, next: NextFunction): void {
  try {
 ...
 */
export function validateCustomPayload(req: Request, res: Response, next: NextFunction): void {
  try {
 ...
 */
export function validateManualPayload(req: Request, res: Response, next: NextFunction): void {
  try {
    const { workflowType, taskDescription } = req.body;
