 ...
 */
export function verifyGitLabToken(req: Request, res: Response, next: NextFunction): void {
  try {
 ...
 */
export function verifyCustomToken(req: Request, res: Response, next: NextFunction): void {
  try {
